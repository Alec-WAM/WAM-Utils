...
public abstract class CustomBoatItem extends BoatItem {
	private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
	private final Type type;
	public CustomBoatItem(Type p_220014_, Properties p_220015_) {
		super(true, p_220014_, p_220015_);
		this.type = p_220014_;
	}
	...
	public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
		...
		if (hitresult.getType() == HitResult.Type.MISS) {
			...
			if (hitresult.getType() == HitResult.Type.BLOCK) {
				...
				Boat boat = this.createBoatEntity(p_40622_, hitresult, x, y, z);
	...
	public abstract Boat createBoatEntity(Level level, HitResult hitresult, double x, double y, double z);
