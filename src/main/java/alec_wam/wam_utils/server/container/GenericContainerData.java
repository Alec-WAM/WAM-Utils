...
import alec_wam.wam_utils.server.container.GenericDataSerializers.DataSerializer;
...
public class GenericContainerData<T>
{
	...
	public static GenericContainerData<?> energy(BlockEnergyStorage blockEnergy)
	{
		return int32(blockEnergy::getEnergyStored, blockEnergy::setEnergy);
	}
	
	public static GenericContainerData<FluidStack> fluid(BlockFluidStorage tank)
	{
