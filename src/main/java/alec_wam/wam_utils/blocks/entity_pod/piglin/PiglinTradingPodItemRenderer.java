...
public class PiglinTradingPodItemRenderer extends WAMUtilsCustomItemRenderer {
...
//	public static final PiglinTradingPodItemRenderer RENDERER = new PiglinTradingPodItemRenderer();
	...
	public static final Supplier<BlockEntityWithoutLevelRenderer> RENDERER = Suppliers.memoize(
			() -> new PiglinTradingPodItemRenderer()
	);
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
		WAMUtilsMod.LOGGER.debug("MODEL RELOAD");
	...
	public void renderByItem(ItemStack stack, TransformType transformType, PoseStack matrix, MultiBufferSource renderer,
		...
		if(piglin == null) {
			piglin = new Piglin(EntityType.PIGLIN, WAMUtilsMod.proxy.getClientWorld());
		}
		matrix.pushPose();
        ...
        Minecraft.getInstance().getEntityRenderDispatcher().render(piglin, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F, matrix, renderer, light);
        matrix.popPose();
