...
public class EnchantedBookModel extends Model {
	public static final ModelLayerLocation BOOK_LAYER = new ModelLayerLocation(new ResourceLocation(WAMUtilsMod.MODID, "book"), "main");
   ...
   public EnchantedBookModel(EntityModelSet entityModelSet) {
       this(entityModelSet.bakeLayer(BOOK_LAYER));
   }
   
   public EnchantedBookModel(ModelPart p_170475_) {
   ...
   public static LayerDefinition createBodyLayer() {
	   ...
	   PartDefinition book = partdefinition.addOrReplaceChild("book", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -10.0F, -3.0F, 2.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
