...
public class EvilPylonBE extends AbstractPylonBE {

	private int spawnDelay = 0;
	
	public EvilPylonBE(BlockPos p_155229_, BlockState p_155230_) {
		super(BlockInit.EVIL_PYLON_BE.get(), p_155229_, p_155230_);
	}
	...
	public void tickClient() {
		...
		if(random.nextInt(10) < 5) {
            ...
            if(level.getBlockState(new BlockPos(spawnX, spawnY, spawnZ)).isAir()) {
            	level.addParticle(ParticleTypes.FLAME, spawnX, spawnY, spawnZ, 0.0D, 0.0D, 0.0D);
            }
	    }
	}
